...
def main():
    ...
    model = torch.nn.DataParallel(model_v, device_ids=[0, 1])
    ...
    train_dataset = vocLoader.VOCDetection('voc', year='2007', image_set='train', download=False, transform=transform_train)
    val_dataset = vocLoader.VOCDetection('voc', year='2007', image_set='val', download=False, transform=transform_val)
